...
import (
	...
	"github.com/prismachain/go-prisma/accounts/scwallet"
	"github.com/prismachain/go-prisma/common"
	"github.com/prismachain/go-prisma/common/hexutil"
	"github.com/prismachain/go-prisma/common/math"
	"github.com/prismachain/go-prisma/consensus"
	"github.com/prismachain/go-prisma/consensus/misc/eip1559"
	"github.com/prismachain/go-prisma/core"
	"github.com/prismachain/go-prisma/core/state"
	...
	"github.com/prismachain/go-prisma/eth/gasestimator"
	"github.com/prismachain/go-prisma/eth/tracers/logger"
	...
	"github.com/prismachain/go-prisma/trie"
...
// EthereumAPI provides an API to access Prisma  related information.
type EthereumAPI struct {
	b Backend
}

// NewEthereumAPI creates a new Prisma  protocol API.
...
// Sign calculates an Prisma  ECDSA signature for:
...
//
// https://gprisma.ethereum.org/docs/interacting-with-gprisma/rpc/ns-personal#personal-sign
...
//
// https://gprisma.ethereum.org/docs/interacting-with-gprisma/rpc/ns-personal#personal-ecrecover
func (s *PersonalAccountAPI) EcRecover(ctx context.Context, data, sig hexutil.Bytes) (common.Address, error) {
	if len(sig) != crypto.SignatureLength {
		return common.Address{}, fmt.Errorf("signature must be %d bytes long", crypto.SignatureLength)
	}
	if sig[crypto.RecoveryIDOffset] != 27 && sig[crypto.RecoveryIDOffset] != 28 {
		return common.Address{}, errors.New("invalid Prisma  signature (V is not 27 or 28)")
	}
...
// Unpair deletes a pairing between wallet and gprisma.
...
// BlockChainAPI provides an API to access Prisma  blockchain data.
type BlockChainAPI struct {
	b Backend
}

// NewBlockChainAPI creates a new Prisma  blockchain API.
func NewBlockChainAPI(b Backend) *BlockChainAPI {
	return &BlockChainAPI{b}
}

// ChainId is the EIP-155 replay-protection chain id for the current Prisma  chain config.
//
...
// DebugAPI is the collection of Prisma  APIs exposed over the debugging
// namespace.
