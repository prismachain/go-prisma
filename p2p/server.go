...
// Package p2p implements the Prisma  p2p network protocols.
package p2p
...
import (
	...
	"github.com/prismachain/go-prisma/p2p/discover"
	"github.com/prismachain/go-prisma/p2p/enode"
	"github.com/prismachain/go-prisma/p2p/enr"
...
type NodeInfo struct {
	...
	ENR   string `json:"enr"`   // Prisma  Node Record
