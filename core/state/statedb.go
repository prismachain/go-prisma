...
// Package state provides a caching layer atop the Prisma  state trie.
package state
...
import (
	...
	"github.com/prismachain/go-prisma/trie/trienode"
	"github.com/prismachain/go-prisma/trie/triestate"
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/prismachain/go-prisma/pull/16485#issuecomment-380438527),
...
func (s *StateDB) handleDestruction(nodes *trienode.MergedNodeSet) (map[common.Address]struct{}, error) {
	// Short circuit if gprisma is running with hash mode. This procedure can consume
