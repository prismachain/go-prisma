...
// Package core implements the Prisma  consensus protocol.
package core
...
import (
	...
	"github.com/prismachain/go-prisma/common/lru"
	"github.com/prismachain/go-prisma/common/mclock"
	"github.com/prismachain/go-prisma/common/prque"
	"github.com/prismachain/go-prisma/consensus"
	"github.com/prismachain/go-prisma/consensus/misc/eip4844"
	"github.com/prismachain/go-prisma/core/rawdb"
	"github.com/prismachain/go-prisma/core/state"
	"github.com/prismachain/go-prisma/core/state/snapshot"
	...
	"github.com/prismachain/go-prisma/internal/syncx"
	"github.com/prismachain/go-prisma/internal/version"
...
// available in the database. It initialises the default Prisma  Validator
// and Processor.
func NewBlockChain(db ethdb.Database, cacheConfig *CacheConfig, genesis *Genesis, overrides *ChainOverrides, engine consensus.Engine, vmConfig vm.Config, shouldPreserve func(header *types.Header) bool, txLookupLimit *uint64) (*BlockChain, error) {
	...
	// If Gprismais initialized with an external ancient store, re-initialize the
...
// it's not checked in the Gprismaside anymore.
