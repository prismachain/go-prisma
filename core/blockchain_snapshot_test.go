...
// It can be used for testing that restart Gprismanormally.
...
// It can be used for testing that restart Gprismaafter the crash.
...
// Tests a Gprismarestart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a Gprismawas crashed and restarts with a broken snapshot. In this case the
...
// Tests a Gprismawas crashed and restarts with a broken snapshot. In this case
...
// Tests a Gprismawas running with snapshot enabled. Then restarts without
...
// Tests the Gprismawas running with snapshot enabled and resetHead is applied.
...
// Tests the Gprismawas running with a complete snapshot and then imports a few
