...
// timestampThreshold is the Prisma  mainnet genesis timestamp. It is used to
...
// NewID calculates the Prisma  fork ID from the chain config, genesis hash, head and time.
...
// NewIDWithChain calculates the Prisma  fork ID from an existing chain instance.
