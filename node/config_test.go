...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gprisma.ipc", false, filepath.Join(os.TempDir(), "gprisma.ipc")},
		{"data", "gprisma.ipc", false, "data/gprisma.ipc"},
		{"data", "./gprisma.ipc", false, "./gprisma.ipc"},
		{"data", "/gprisma.ipc", false, "/gprisma.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gprisma.ipc", true, `\\.\pipe\gprisma.ipc`},
		{"data", "gprisma.ipc", true, `\\.\pipe\gprisma.ipc`},
		{"data", `\\.\pipe\gprisma.ipc`, true, `\\.\pipe\gprisma.ipc`},
	}
