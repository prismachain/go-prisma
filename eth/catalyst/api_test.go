...
import (
	...
	"github.com/prismachain/go-prisma/beacon/engine"
	...
	beaconConsensus "github.com/prismachain/go-prisma/consensus/beacon"
	"github.com/prismachain/go-prisma/consensus/ethash"
...
var (
	...
	// testAddr is the Prisma  address of the tester account.
...
func startEthService(t *testing.T, genesis *core.Genesis, blocks []*types.Block) (*node.Node, *eth.Prisma ) {
	t.Helper()
...
func setupBlocks(t *testing.T, ethservice *eth.Prisma , n int, parent *types.Header, callback func(parent *types.Header), withdrawals [][]*types.Withdrawal) []*types.Header {
	api := NewConsensusAPI(ethservice)
...
func setupBodies(t *testing.T) (*node.Node, *eth.Prisma , []*types.Block) {
	genesis, blocks := generateMergeChain(10, true)
