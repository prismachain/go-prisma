...
// FullSyncTester is an auxiliary service that allows Gprismato perform full sync
...
func RegisterFullSyncTester(stack *node.Node, backend *eth.Prisma , target common.Hash) (*FullSyncTester, error) {
	cl := &FullSyncTester{
		stack:   stack,
		backend: backend,
		target:  target,
