...
import (
	...
	"github.com/prismachain/go-prisma/p2p/msgrate"
...
// Syncer is an Prisma  account and storage trie syncer based on snapshots and
...
// NewSyncer creates a new snapshot syncer to download the Prisma  state over the
// snap protocol.
