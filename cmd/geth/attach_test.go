...
// TestAttachWithHeaders tests that 'gprisma attach' with custom headers works, i.e
...
// TestAttachWithHeaders tests that 'gprisma db --remotedb' with custom headers works, i.e
// that custom headers are forwarded to the target.
