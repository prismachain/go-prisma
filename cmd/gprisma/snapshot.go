		...
		Subcommands: []*cli.Command{
			{
				...
				Description: `
gprisma snapshot prune-state <state-root>
...
`,
			},
			{
				...
				Description: `
gprisma snapshot verify-state <state-root>
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabaseFlags),
				Description: `
gprisma snapshot check-dangling-storage <state-root> traverses the snap storage
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabaseFlags),
				Description: `
gprisma snapshot inspect-account <address | hash> checks all snapshot layers and prints out
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabaseFlags),
				Description: `
gprisma snapshot traverse-state <state-root>
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabaseFlags),
				Description: `
gprisma snapshot traverse-rawstate <state-root>
...
`,
			...
			{
				Name:      "dump",
				Usage:     "Dump a specific block from storage (same as 'gprisma dump' but using snapshots)",
				...
				Description: `
This command is semantically equivalent to 'gprisma dump', but uses the snapshots
