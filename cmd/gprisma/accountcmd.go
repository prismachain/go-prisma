...
var (
	walletCommand = &cli.Command{
		Name:      "wallet",
		Usage:     "Manage Prisma  presale wallets",
		ArgsUsage: "",
		Description: `
    gprisma wallet import /path/to/my/presale.wallet
		...
		Subcommands: []*cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Prisma  presale wallet",
				ArgsUsage: "<keyFile>",
				Action:    importWallet,
				Flags: []cli.Flag{
					utils.DataDirFlag,
				...
				Description: `
	gprisma wallet [options] /path/to/my/presale.wallet
...
`,
			},
			{
				...
				Description: `
    gprisma account update <address>
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gprisma account update [options] <address>
...
`,
			},
			{
				...
				ArgsUsage: "<keyFile>",
				Description: `
    gprisma account import <keyfile>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    gprisma account import [options] <keyfile>
