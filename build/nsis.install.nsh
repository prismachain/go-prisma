Name "gprisma ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/prismachain/go-prisma/issues"
!define UPDATEURL "https://github.com/prismachain/go-prisma/releases"
!define ABOUTURL "https://github.com/prismachain/go-prisma#ethereum-go"
...
Section "Geth" GETH_IDX
  ...
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gprisma.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gprisma.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gprismaincoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gprismaoutgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "GprismaUDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gprismaincoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gprisma.exe" "" "" "Prisma " 30303 "" "" ""
  SimpleFC::AdvAddRule "Gprismaoutgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gprisma.exe" "" "" "Prisma " "" 30303 "" ""
  SimpleFC::AdvAddRule "GprismaUDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gprisma.exe" "" "" "Prisma " "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gprisma.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gprisma.ipc"
