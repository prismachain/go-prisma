...
# 1. install gprisma for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gprisma
# 5. create gprisma, attach and uninstall start menu entries
...
!define GROUPNAME "Prisma "
!define APPNAME "Geth"
!define DESCRIPTION "Official Go implementation of the Prisma  protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gprisma is installed global
