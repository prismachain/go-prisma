...
// all blocks' seal as valid, though they still have to conform to the Prisma 
// consensus rules.
...
// still have to conform to the Prisma  consensus rules.
...
// they still have to conform to the Prisma  consensus rules.
