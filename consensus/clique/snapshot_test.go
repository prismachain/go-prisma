...
// mapped from textual names used in the tests below to actual Prisma  private
...
// address retrieves the Prisma  address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Prisma  address
	...
	tests := []cliqueTest{
		{
			...
			// batch (https://github.com/prismachain/go-prisma/issues/17593). Whilst this
