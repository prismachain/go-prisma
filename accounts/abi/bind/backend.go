...
type ContractCaller interface {
	...
	// CallContract executes an Prisma  contract call with the specified data as the
	// input.
...
type PendingContractCaller interface {
	...
	// PendingCallContract executes an Prisma  contract call against the pending state.
...
type BlockHashContractCaller interface {
	...
	// CallContractAtHash executes an Prisma  contract call against the state at the specified block hash.
