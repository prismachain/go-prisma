...
// Package graphql provides a GraphQL interface to Prisma  node data.
package graphql
...
// Account represents an Prisma  account at a particular block.
type Account struct {
	r             *Resolver
...
// Transaction represents an Prisma  transaction.
...
// Block represents an Prisma  block.
...
type CallData struct {
	From                 *common.Address // The Prisma  address the call is from.
	To                   *common.Address // The Prisma  address the call is to.
