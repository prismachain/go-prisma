...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte Prisma  address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an Prisma  account at a particular block.
    type Account {
    ...
    # Transaction is an Prisma  transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an Prisma  account at the current block's state.
    ...
    type Pending {
        ...
        transactions: [Transaction!]
        # Account fetches an Prisma  account for the pending state.
        account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an Prisma  block by number or by hash. If neither is
