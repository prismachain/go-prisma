...
import (
	...
	"github.com/prismachain/go-prisma/internal/jsre"
	"github.com/prismachain/go-prisma/internal/jsre/deps"
	"github.com/prismachain/go-prisma/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute Prisma  requests through
...
// Welcome show summary of current Gprismainstance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the GprismaJavaScript console!\n\n"

	// Print some generic Gprismametadata
